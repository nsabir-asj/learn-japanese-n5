    ...
    panel.innerHTML = `
      ...
      <details class="card vocab-setup-card" id="vocabSessionControls">
        ...
        <div class="vocab-setup">
          ...
          <div class="vocab-inline-playback"><label class="toggle-line"><input type="checkbox" id="vocabAutoPronounce"> Automatically pronounce revealed words</label><small class="vocab-inline-playback-note">Listening questions already play the prompt; use Replay word when needed.</small><button class="ghost" id="vocabManageVoices" type="button">Manage voices</button></div>
        </div>
      </details>
