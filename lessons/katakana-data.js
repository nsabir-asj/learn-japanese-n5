(() => {
  ...
  const MNEMONICS = {
    "ア":"An axe leans against a tree: axe begins with ‘a’.",
    "イ":"An easel has two angled legs: easel begins with the ‘ee’ sound.",
    "ウ":"A person lifts a tray and says ‘ooh’ under its weight.",
    "エ":"An elevator has three straight levels: elevator begins with e.",
    "オ":"An opera singer raises one arm beside a stand: opera begins with o.",
    "カ":"A kite frame has one loose tail: kite gives the k sound in ka.",
    "キ":"A key has three teeth crossing its stem: key sounds like ki.",
    "ク":"A cuckoo opens its angular beak and calls ‘ku.’",
    "ケ":"A keg has a lid, side, and slanted tap: keg begins with ke.",
    "コ":"Two corners face the same way: corner begins with ko.",
    "サ":"A saddle has crossing straps and an open seat: saddle begins with sa.",
    "シ":"She smiles upward; the two drops point toward the rising curve.",
    "ス":"A skier sweeps down a slope: ski begins with su.",
    "セ":"A sailor’s mast is crossed by a loose sail: sailor begins with se.",
    "ソ":"A sewing needle drops downward; its marks flow from top to bottom.",
    "タ":"A tall person wears a wide hat: tall begins with ta.",
    "チ":"A cheerleader’s arm crosses a curved body: cheer begins like chi.",
    "ツ":"A tsunami’s spray falls from high drops into a curling wave.",
    "テ":"A telephone pole has two wires and a slanted support: telephone begins with te.",
    "ト":"A toe catches a tiny thorn on a vertical leg: toe begins with to.",
    "ナ":"A knife makes one diagonal cut through a handle: knife gives the n sound in na.",
    "ニ":"Two needles lie flat and parallel: needle begins with ni.",
    "ヌ":"Noodles cross, then curl into a final loop: noodles begin with nu.",
    "ネ":"A net is tied from a crossbar into a curling knot: net begins with ne.",
    "ノ":"A single noodle slopes down in one clean stroke: noodle begins with no.",
    "ハ":"A roof splits into two halves: half begins with ha.",
    "ヒ":"A person says ‘hee!’ while sliding along a bent rail.",
    "フ":"Mount Fuji’s two slopes meet under a snowy ridge: Fuji begins with fu.",
    "ヘ":"A hill has one sharp peak: hill helps recall he.",
    "ホ":"A holy cross shines with four rays: holy begins with ho.",
    "マ":"A map is folded into an angular corner: map begins with ma.",
    "ミ":"Three musical notes slope in a row: music begins with mi.",
    "ム":"A cow’s angular face ends with a tail and says ‘moo.’",
    "メ":"A medal’s two ribbons cross: medal begins with me.",
    "モ":"A fishing rod holds two pieces of moss: moss begins with mo.",
    "ヤ":"A yak has two horns above one sweeping back: yak begins with ya.",
    "ユ":"A U-shaped shelf has a bar across it: U helps recall yu.",
    "ヨ":"A yo-yo shelf has three stacked levels: yo-yo begins with yo.",
    "ラ":"A rabbit shelters under one short roof: rabbit gives the r sound in ra.",
    "リ":"Two reeds stand upright, the right one longer: reeds begin with ri.",
    "ル":"A route drops, turns sharply, and flicks upward: route begins with ru.",
    "レ":"A reindeer’s leg bends and kicks outward: reindeer begins with re.",
    "ロ":"A road forms a simple square block: road begins with ro.",
    "ワ":"A wine glass has an angled bowl and one side: wine begins with wa.",
    "ヲ":"Two shelves cross a sweeping path; this particle is usually read ‘o.’",
    "ン":"The marks move left to right into a low curve; think of the final n sound."
  };
